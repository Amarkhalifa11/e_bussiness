...
@section('content')
    <h1 class="text-center "><b>add service</b> </h1>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control is-valid"
                                            id="validationServer01" placeholder="service title" value="" required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="icon" class="form-control is-valid"
                                            id="validationServer01" placeholder="service icon" value="" required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea type="text" name="description" class="form-control is-valid" id="validationServer01"
                                            placeholder="service description" value="" required></textarea>
